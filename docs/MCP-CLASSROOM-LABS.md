...
**API references:** [integration guide](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/API-INTEGRATION-GUIDE.md) · [WLAN scan](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/api/wlan-scan.md) · [reachability/speedtest](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/api/reachability-speedtest.md) · [capture design](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/api/wifi-capture.md) · [capture consumer guide](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/api/wifi-capture-consumer-guide.md) · [deprecated routes](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/API-DEPRECATED-ENDPOINTS.md) · [NETWORK_CONFIG.md](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/NETWORK_CONFIG.md)
...
Aligned with [API-INTEGRATION-GUIDE.md](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/API-INTEGRATION-GUIDE.md) and [capture design §10](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/api/wifi-capture.md#10-mcp-tool-mapping). Generated names will differ between MCP servers — **grade the REST path in the transcript, never the tool name.**
...
- Keep capture tool names aligned with [wifi-capture.md §10](https://github.com/WLAN-Pi/wlanpi-core/blob/dev/docs/api/wifi-capture.md#10-mcp-tool-mapping).
