...
**Status:** Design record. The authentication and transport described here is implemented in wlanpi-core; see [mcp-rollout.md](./mcp-rollout.md) for what landed and what remains.
