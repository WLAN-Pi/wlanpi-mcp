#!/bin/bash
#
# Build wlanpi-mcp Debian package in a container (podman or docker)
#
...
IMAGE="wlanpi-mcp-builder:${SUITE}"

echo "========================================="
echo "Building wlanpi-mcp Debian Package"
echo "  engine: $ENGINE"
echo "  suite:  $SUITE"
echo "========================================="
...
ls -lh wlanpi-mcp*.deb 2>/dev/null || echo "No wlanpi-mcp .deb files found"
echo ""
echo "To install the package:"
echo "  sudo dpkg -i wlanpi-mcp*.deb"
